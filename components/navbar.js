                    ...
                    <div className='w-full max-w-[1388px] mx-auto'>
                        <div className='flex items-center justify-between relative'>
                            <div className='flex items-center relative z-10'>
                                <div className='inline-block pt-1 pb-1 relative'>
                                    <Link href="/" className='flex items-center cursor-pointer'>
                                        ...
                                        <h1 className='text-4xl leading-5 discordbtn:block hidden'>
                            ...
                            <div className='flex items-center flex-row gap-1'>
                                ...
                                <button className='hidden favbtn:inline-flex hover:bg-[#0c0c0c] rounded-full  items-center justify-center relative align-middle leading-5 font-semibold h-10 min-w-10 text-base px-4' onClick={handleOpenSearch}>
                                ...
                                </button>
                                {
                                    (parentFavs ? parentFavs.length > 0 : favs.length > 0) ?
                                        <Link href={`/${pageData.lang}/fav`} className='hidden searchbtn:inline-flex hover:bg-[#0c0c0c] rounded-full inline-flex items-center justify-center relative align-middle leading-5 font-semibold h-10 min-w-10 text-base px-4'>
                                        ...
                                        <button className='hidden searchbtn:inline-flex cursor-no-drop hover:bg-[#0c0c0c] rounded-full inline-flex items-center justify-center relative align-middle leading-5 font-semibold h-10 min-w-10 text-base px-4'>
                                            <svg fill="currentColor" stroke-width="0" viewBox="0 0 576 512" stroke="currentColor" height="1em" width="1em" aria-hidden="true" focusable="false"
