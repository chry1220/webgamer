                    ...
                    <div className='w-full max-w-[1388px] mx-auto'>
                        <div className='flex items-center justify-between relative'>
                                ...
                                <div className='inline-block pt-1 pb-1 relative'>
                                    <Link href="/" className='flex items-center cursor-pointer'>
                                        ...
                                        <h1 className='text-4xl leading-5 discordbtn:block hidden'>
                                            <img width="1447" height="130" className='max-w-[150px] sm:max-w-[160px] md:max-w-[180px] w-full  aspect-[19/2]' alt="WebGamer" src="https://webgamer.io/fonts/logo-text-spaced-optim.svg"></img>
                                        </h1>
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center flex-row gap-1'>
                                <button className='hover:bg-[#0c0c0c] rounded-full inline-flex items-center justify-center relative align-middle leading-5 font-semibold h-10 min-w-10 text-base xl:hidden md:px-4 hover:bg-[#0c0c0c]' onClick={openDrawer}>
