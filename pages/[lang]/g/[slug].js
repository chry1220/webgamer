                                                            ...
                                                            <div className="mb-6">
                                                                ...
                                                                }
                                                                {
                                                                    gameData.players.map(player => (
                                                                        <Link href={`/en/player/${player.slug}`} className="border border-gray-600 text-white bg-transparent hover:bg-gray-900 rounded-full text-base inline-flex items-center justify-center relative align-middle leading-5 min-w-8 h-8 px-3 mr-3" key={player.slug}>
...

                                                                {
                                                                    gameData.superficialEngine ?
                                                                        <div className="text-base pb-2">{pageData.pageTr["Engine:"]}
                                                                            <Link href={`/${pageData.lang}/engine/${gameData.superficialEngine.slug}`} className="ml-1 font-semibold hover:border-b cursor-pointer">
